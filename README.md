...
- "inputMode"
  ...
  - "non-touch" → unread messages display immediately when they arrive, then automatically switch back to the message screen every 2 minutes 30 seconds for 30 seconds
